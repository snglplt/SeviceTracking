...
class islerim_getir_adapter (private val newsList : ArrayList<IslerimModel>) :
    RecyclerView.Adapter<islerim_getir_adapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.btn_baslat.setOnClickListener {
            val imservis = Intent(currentItem.context, IsBilgiActivity::class.java)
